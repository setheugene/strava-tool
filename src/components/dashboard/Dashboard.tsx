  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        />
        <StatCard
          title={`Miles Ridden in ${selectedYear}`}
          value={stats.totalMilesRidden.toFixed(1)}
          subtitle="miles"
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        />
        <StatCard
          title={`Rides in ${selectedYear}`}
          value={String(stats.totalRidesThisYear)}
          subtitle="activities"
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        ...
        <StatCard
          ...
          subtitle={`all activities in ${selectedYear}`}
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <BestEffortsCard efforts={stats.bestEfforts} year={selectedYear} />
      </div>
